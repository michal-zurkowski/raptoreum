...
constexpr static CAmount
DEFAULT_MAX_RAW_TX_FEE{
COIN / 10};

void ScriptPubKeyToUnivalue(const CScript &scriptPubKey, UniValue &out, bool fIncludeHex) {
    txnouttype type;
    ...
    if (type == TX_TRANSFER_ASSET) {
        ...
        if (GetTransferAsset(scriptPubKey, data)) {
            ...
            if (!passetsCache->GetAssetMetaData(data.assetId, tmpAsset)) {
                throw JSONRPCError(RPC_INVALID_PARAMETER, "Error: Asset asset metadata not found");
            }
            assetInfo.pushKV("name", tmpAsset.name);
...
void TxToJSON(const CTransaction &tx, const uint256 hashBlock, UniValue &entry) {
    // bitcoin-common doen not have access to asset cache, changed to local function to decode the transaction hex.
    ...
    for (unsigned int i = 0; i < tx.vout.size(); i++) {
        ...
        UniValue o(UniValue::VOBJ);
        ScriptPubKeyToUnivalue(txout.scriptPubKey, o, true);
               ...
               },
               {
                       ...
                       RPCResult{"if verbose is set to true",
                                 RPCResult::Type::OBJ, "", "",
                                 {
                                         ...
                                         {RPCResult::Type::NUM, "extraPayloadSize", true /*optional*/,
                                          "Size of DIP2 extra payload. Only present if it's a special TX"},
                                         {RPCResult::Type::STR_HEX, "extraPayload", true /*optional*/,
                                          "Hex-encoded DIP2 extra payload data. Only present if it's a special TX"},
                                         ...
                                         {RPCResult::Type::BOOL, "instantlock_internal",
                                          "Current internal transaction lock state"},
                                         {RPCResult::Type::BOOL, "chainlock",
                                          "he state of the corresponding block chainlock"},
                                 }
                       },
               },
               RPCExamples{
...
static UniValue gettxoutproof(const JSONRPCRequest &request) {
    ...
    if (pblockindex == nullptr) {
        const CTransactionRef tx = GetTransaction(/* block_index */ nullptr, /* mempool */ nullptr, oneTxid,
               ...
               "it is not stored in the wallet or transmitted to the network.\n",
               {
                       ...
                       {"outputs", RPCArg::Type::ARR, RPCArg::Optional::NO,
                        ...
                        "                             accepted as second parameter.",
                        {
                                ...
                                {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                 {
                                         {"future_maturity", RPCArg::Type::NUM, RPCArg::Optional::NO,
...
static UniValue combinerawtransaction(const JSONRPCRequest &request) {
    RPCHelpMan{"combinerawtransaction",
               ...
               {
                       {"txs", RPCArg::Type::ARR, RPCArg::Optional::NO,
    ...
    RPCHelpMan{"signrawtransactionwithkey",
               ...
               "this transaction depends on but may not yet be in the block chain.\n",
               {
                       ...
                       {"privkeys", RPCArg::Type::ARR, RPCArg::Optional::NO,
                        ...
                        {
                                {"privatekey", RPCArg::Type::STR_HEX, RPCArg::Optional::OMITTED,
                                ...
                                {"", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED, "",
                                 {
                                         ...
                                         {"redeemScript", RPCArg::Type::STR_HEX, RPCArg::Optional::OMITTED,
                                          "(required for P2SH or P2WSH) redeem script"},
...
UniValue sendrawtransaction(const JSONRPCRequest &request) {
    RPCHelpMan{"sendrawtransaction",
               ...
               "\nAlso see createrawtransaction and signrawtransactionwithkey calls.\n",
               {
                       ...
                       {"bypasslimits", RPCArg::Type::BOOL, /* default_val */ "false",
    ...
    NodeContext &node = EnsureNodeContext(request.context);
    const TransactionError err = BroadcastTransaction(node, tx, err_string, max_raw_tx_fee, /* relay */
                                                      true, /* wait_callback */ true, bypass_limits);
